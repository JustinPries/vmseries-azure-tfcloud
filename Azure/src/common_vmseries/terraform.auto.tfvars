      ...
      "management" = {
        ...
        rules = {
          vmseries_mgmt_allow_inbound = {
            ...
            access                     = "Allow"
            protocol                   = "Tcp"
            source_address_prefixes    = ["165.166.252.143"] # TODO: whitelist public IP addresses that will be used to manage the appliances
            source_port_range          = "*"
...
load_balancers = {
  "public" = {
    ...
    nsg_key                           = "public"
    network_security_allow_source_ips = ["165.166.252.143"] # Put your own public IP address here  <-- TODO to be adjusted by the customer
    avzones                           = ["1", "2", "3"]
    frontend_ips = {
      "palo-lb-app1" = {
